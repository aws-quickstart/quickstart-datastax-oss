...
Also, make sure that the domain name option in the Dynamic Host Configuration Protocol (DHCP) options is configured as explained in the Amazon VPC documentation. For more information, see http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html[DHCP options sets^]. You provide your VPC settings when you launch the Quick Start.
